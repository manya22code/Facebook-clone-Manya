    ...
    return (
        <div className="Main">
            ...
            <div className="Profile">
                <img src="/images/dp2.png"alt="dp"style={{height:"60px",padding:"1rem"}}/>
                Manya Premjith
            </div>
            <div className="Pro">
            ...
            <div className="MainArea">
                <div className="addStory">
                    <div className="Story">
                        <img src="/images/dp1.png" alt="IMG" style={{height:"60px", width:"50px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="message">
                        <div className="text">
                            <div className="Post">
                                <img src="/images/dp1.png" alt="PIC"/>
                                <input type="Mind" placeholder="What's on your mind, Manya?"/>
                            </div>
                            <div className="Call">
                                <div className="ico">
                                    <div className="icone">
                    ...
                    <div className="Posted">
                        <div className="poster">
                            <div className="Simplilearn">
                                <img src="/images/dp1.png" alt="Img" style={{height:"50px", width:"50px", borderRadius:"50%"}}/>
                                Manya 
                        ...
                        <div className="FacebookImg">
                            <img src="/images/dp2.png" alt="dp" style={{height:"auto",width:"100%"}}/>
                        </div>
